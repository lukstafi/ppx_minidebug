...
- <details><summary>update_step =</summary>
  ...
  - ```
    (shape
     ((batch
       ((dims ()) (bcast (Row_var (Row_var 38))) (id ((sh_id 23) (kind Batch)))))
      (input
  ...
  - <details><summary><span style="font-family: monospace">logic</span></summary>
    ...
    - <details><summary><span style="font-family: monospace">Broadcast</span></summary>
      ...
      - `Compose`
      - ```
        ((batch ((dims ()) (bcast Broadcastable) (id ((sh_id 8) (kind Batch)))))
         (input
          ((dims ()) (bcast (Row_var (Row_var 4))) (id ((sh_id 8) (kind Input)))))
         (output
          ((dims ()) (bcast (Row_var (Row_var 5))) (id ((sh_id 8) (kind Output)))))
         (id 8) (debug_name w1))
        ```
      ...
      - ```
        ((batch
         ...
         (input ((dims ()) (bcast Broadcastable) (id ((sh_id 21) (kind Input)))))
         (output
          ((dims ((Dim (d 2) (label ()) (proj_id ())))) (bcast Broadcastable)
           (id ((sh_id 21) (kind Output)))))
         (id 21) (debug_name moons_input))
        ```
  ...
  - <details><summary>ineqs =</summary>
    ...
    - ```
      (Row_ineq
       (cur
        ((dims ()) (bcast (Row_var (Row_var 38))) (id ((sh_id 23) (kind Batch)))))
       (subr ((dims ()) (bcast Broadcastable) (id ((sh_id 8) (kind Batch))))))
      ```
    ...
    - ```
      (Row_ineq
       (cur
        ((dims ()) (bcast (Row_var (Row_var 39))) (id ((sh_id 23) (kind Input)))))
       (subr ((dims ()) (bcast Broadcastable) (id ((sh_id 21) (kind Input))))))
      ```
  ...
  - <details><summary>solve =</summary>
    ...
    - <details><summary>solve_row_ineq =</summary>
      ...
      - <details><summary><returns></summary>
        ...
        - <details><summary></summary>
          ...
          - ```
            (Row_eq
             (r1 ((dims ()) (bcast (Row_var (Row_var 4))) (id ((sh_id 8) (kind Input)))))
             (r2
              ((dims ((Var ((id 41) (label ()))))) (bcast (Row_var (Row_var 42)))
               (id ((sh_id 8) (kind Input))))))
            ```
          ...
          - ```
            (Dim_ineq (cur (Var ((id 41) (label ()))))
             (subr (Dim (d 2) (label ()) (proj_id ()))))
            ```
      ...
      - <details><summary><match -- branch 3></summary>
        ...
        - <details><summary><span style="font-family: monospace">more_dims = ((Var ((id 41) (label ()))))</span></summary>
        ...
        - <details><summary>template =</summary>
          ...
          - <details><summary><returns></summary>
            ...
            - `(dims ((Var ((id 41) (label ())))))`
            - `(bcast (Row_var (Row_var 42)))`
            - `(id ((sh_id 8) (kind Input)))`
            </details>
          </details>
        - <details><summary><span style="font-family: monospace">subr_dims = ((Dim (d 2) (label ()) (proj_id ())))</span></summary>
    ...
    - <details><summary>solve_row_ineq =</summary>
          ...
          - ```
            (Row_eq
             (r1
              ((dims ()) (bcast (Row_var (Row_var 38))) (id ((sh_id 23) (kind Batch)))))
             (r2
              ((dims ((Var ((id 43) (label ()))))) (bcast (Row_var (Row_var 44)))
               (id ((sh_id 23) (kind Batch))))))
            ```
      ...
      - <details><summary><match -- branch 3></summary>
        ...
        - ["lib/row.ml":587:4](./lib/row.ml#L587)
        - <details><summary><span style="font-family: monospace">more_dims = ((Var ((id 43) (label ()))))</span></summary>
    ...
    - <details><summary>solve =</summary>
      ...
      - <details><summary>solve_dim_ineq =</summary>
        ...
        - <details><summary><returns></summary>
          ...
          - ```
            ((Dim_eq (d1 (Var ((id 41) (label ()))))
              (d2 (Dim (d 2) (label ()) (proj_id ())))))
            ```
      ...
      - <details><summary>solve =</summary>
        ...
        - <details><summary>unify_dim =</summary>
          ...
          - <details><summary><span style="font-family: monospace">dim1 = (Var ((id 41) (label ())))</span></summary>
            
            - ["lib/row.ml":235:6](./lib/row.ml#L235)
            </details>
          - <details><summary><span style="font-family: monospace">dim2 = (Dim (d 2) (label ()) (proj_id ()))</span></summary>
        ...
        - <details><summary>unify_dim =</summary>
          ...
          - <details><summary><span style="font-family: monospace">dim1 = (Var ((id 43) (label ())))</span></summary>
