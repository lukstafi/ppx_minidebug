  ...
  (let __entry_id = Debug_runtime.get_entry_id () in
   ...
   then
     ...
     ((Debug_runtime.open_log ~fname:"test_debug_interrupts.ml"
         ~start_lnum:11 ~start_colnum:35 ~end_lnum:13 ~end_colnum:55
      ...
      then
        ...
        (match let z =
                 ...
                 then
                   ...
                   (Debug_runtime.open_log ~fname:"test_debug_interrupts.ml"
                      ~start_lnum:12 ~start_colnum:6 ~end_lnum:12
                      ~end_colnum:7 ~message:"z" ~entry_id:__entry_id
                      ~log_level:1 `Debug;
                    if Debug_runtime.exceeds_max_nesting ()
                    then
                      (Debug_runtime.log_value_show ~descr:"z"
                       ...
                       Debug_runtime.close_log
                         ~fname:"test_debug_interrupts.ml" ~start_lnum:12
                         ~entry_id:__entry_id;
                       failwith "ppx_minidebug: max_nesting_depth exceeded")
                    else
                      (match (x - 1) / 2 with
...
let bar () =
  (let __entry_id = Debug_runtime.get_entry_id () in
   ...
   then
     ...
     (Debug_runtime.open_log ~fname:"test_debug_interrupts.ml" ~start_lnum:20
        ~start_colnum:21 ~end_lnum:24 ~end_colnum:6 ~message:"bar : unit"
      ...
      then
        ...
        (match let __entry_id = Debug_runtime.get_entry_id () in
               Debug_runtime.open_log ~fname:"test_debug_interrupts.ml"
                 ~start_lnum:21 ~start_colnum:2 ~end_lnum:24 ~end_colnum:6
                 ~message:"for:test_debug_interrupts:21" ~entry_id:__entry_id
                 ~log_level:1 `Track;
               (match for i = 0 to 100 do
                        ...
                        then
                          ...
                          (Debug_runtime.open_log
                             ~fname:"test_debug_interrupts.ml" ~start_lnum:21
                           ...
                           then
                             ...
                             (match let _baz =
                                      ...
                                      then
                                        ...
                                        (Debug_runtime.open_log
                                           ~fname:"test_debug_interrupts.ml"
                                           ~start_lnum:22 ~start_colnum:8
                                           ~end_lnum:22 ~end_colnum:12
                                           ~message:"_baz"
                                           ~entry_id:__entry_id ~log_level:1
                                           `Track;
                                         if
