  ...
  let module Debug_runtime = (val
    ...
    (let __scope_id = Debug_runtime.get_scope_id () in
     Debug_runtime.open_log ~fname:"test_debug_log_prefixed.ml"
       ...
       ~message:"bar" ~scope_id:__scope_id ~log_level:1 `Track;
     ();
     (match let __scope_id = Debug_runtime.get_scope_id () in
            Debug_runtime.open_log ~fname:"test_debug_log_prefixed.ml"
              ~start_lnum:22 ~start_colnum:2 ~end_lnum:26 ~end_colnum:6
              ~message:"for:test_debug_log_prefixed:22" ~scope_id:__scope_id
              ~log_level:1 `Track;
            (match for i = 0 to 10 do
                     ...
                     Debug_runtime.open_log
                       ...
                       ~message:"<for i>" ~scope_id:__scope_id ~log_level:1
                       `Track;
                     ...
                     (match let _baz : int =
                            ...
                            Debug_runtime.log_value_show ?descr:None
                              ~scope_id:__scope_id ~log_level:2
                              ~is_result:false
                              (lazy
