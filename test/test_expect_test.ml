...
let%expect_test "%track_this_show PrintBox tracking" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      "test/test_expect_test.ml":920:37: track_branches
      ├─x = 7
      ├─"test/test_expect_test.ml":922:9: else:test_expect_test:922
      │ └─"test/test_expect_test.ml":922:36: <match -- branch 1>
      └─track_branches = 4
      4
      "test/test_expect_test.ml":920:37: track_branches
      ├─x = 3
      ├─"test/test_expect_test.ml":921:18: then:test_expect_test:921
      │ └─"test/test_expect_test.ml":921:54: <match -- branch 2>
      └─track_branches = -3
      -3
    |}]
...
let%expect_test "%track_this_show PrintBox tracking <function>" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      "test/test_expect_test.ml":953:11: <function -- branch 3>
      4
      "test/test_expect_test.ml":955:11: <function -- branch 5> x
      -3
    |}]
...
let%expect_test "%track_this_show PrintBox tracking with debug_notrace" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      "test/test_expect_test.ml":974:37: track_branches
      ├─x = 8
      ├─"test/test_expect_test.ml":983:6: else:test_expect_test:983
      │ └─"test/test_expect_test.ml":987:10: <match -- branch 2>
      │   └─"test/test_expect_test.ml":987:14: result
      │     ├─"test/test_expect_test.ml":987:44: then:test_expect_test:987
      │     └─result = 8
      └─track_branches = 8
      8
      "test/test_expect_test.ml":974:37: track_branches
      ├─x = 3
      ├─"test/test_expect_test.ml":976:6: then:test_expect_test:976
      │ └─"test/test_expect_test.ml":980:14: result
      │   └─result = 3
      └─track_branches = 3
      3
    |}]
...
let%expect_test "%track_show PrintBox not tracking anonymous functions with debug_notrace"
  ...
  [%expect
    {|
    BEGIN DEBUG SESSION
    "test/test_expect_test.ml":1020:27: track_foo
    ├─x = 8
    ├─"test/test_expect_test.ml":1023:4: fun:test_expect_test:1023
    │ └─z = 8
    └─track_foo = 8
    8 |}]
...
let%expect_test "respect scope of nested extension points" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      "test/test_expect_test.ml":1042:37: track_branches
      ├─x = 8
      ├─"test/test_expect_test.ml":1051:6: else:test_expect_test:1051
      │ └─"test/test_expect_test.ml":1055:25: result
      │   ├─"test/test_expect_test.ml":1055:55: then:test_expect_test:1055
      │   └─result = 8
      └─track_branches = 8
      8
      "test/test_expect_test.ml":1042:37: track_branches
      ...
      │ └─"test/test_expect_test.ml":1048:25: result
      │   └─result = 3
      └─track_branches = 3
      3
    |}]
...
let%expect_test "%debug_show un-annotated toplevel fun" =
  ...
  [%expect
    {|
    BEGIN DEBUG SESSION
    "test/test_expect_test.ml":1086:27: anonymous
...
let%expect_test "%debug_show nested un-annotated toplevel fun" =
  ...
  [%expect
    {|
    BEGIN DEBUG SESSION
    "test/test_expect_test.ml":1111:25: wrapper
    "test/test_expect_test.ml":1112:29: anonymous
    └─"We do log this function"
    6
    6
  |}]
...
let%expect_test "%track_this_show no return type anonymous fun" =
  ...
  [%expect
    {|
    BEGIN DEBUG SESSION
    "test/test_expect_test.ml":1140:32: anonymous
    └─x = 3
    6
  |}];
  ...
  [%expect
    {|
      "test/test_expect_test.ml":1154:32: anonymous
      ├─x = 3
      ├─"test/test_expect_test.ml":1155:50: fun:test_expect_test:1155
      │ └─i = 0
      ├─"test/test_expect_test.ml":1155:50: fun:test_expect_test:1155
      │ └─i = 1
      ├─"test/test_expect_test.ml":1155:50: fun:test_expect_test:1155
...
let%expect_test "%track_this_show anonymous fun, num children exceeded" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      "test/test_expect_test.ml":1178:40: loop_exceeded
      ├─x = 3
      └─"test/test_expect_test.ml":1184:11: fun:test_expect_test:1184
        ├─i = 0
        ├─"test/test_expect_test.ml":1185:17: z
        │ └─z = 1
        └─"test/test_expect_test.ml":1186:35: else:test_expect_test:1186
          └─"test/test_expect_test.ml":1178:40: loop_exceeded
            ├─x = 2
            └─"test/test_expect_test.ml":1184:11: fun:test_expect_test:1184
              ├─i = 0
                  ...
                  └─"test/test_expect_test.ml":1184:11: fun:test_expect_test:1184
                    ...
                    └─"test/test_expect_test.ml":1186:35: else:test_expect_test:1186
                      └─"test/test_expect_test.ml":1178:40: loop_exceeded
                        ...
                        │ ├─"test/test_expect_test.ml":1185:17: z
                        │ │ └─z = 0
                        │ └─"test/test_expect_test.ml":1186:28: then:test_expect_test:1186
                        ├─"test/test_expect_test.ml":1184:11: fun:test_expect_test:1184
                        │ ├─i = 1
                        │ ├─"test/test_expect_test.ml":1185:17: z
                        │ │ └─z = 1
                        ...
                        │ │ └─z = 9
                        │ └─"test/test_expect_test.ml":1186:28: then:test_expect_test:1186
                        └─fun:test_expect_test:1184 = <max_num_children exceeded>
      Raised exception: ppx_minidebug: max_num_children exceeded
    |}]
...
let%expect_test "%track_this_show anonymous fun, truncated children" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      "test/test_expect_test.ml":1274:40: loop_exceeded
      ├─<earlier entries truncated>
      ├─"test/test_expect_test.ml":1278:9: fun:test_expect_test:1278
      │ ├─<earlier entries truncated>
      │ ├─"test/test_expect_test.ml":1279:15: z
      │ │ └─z = 7
      │ └─"test/test_expect_test.ml":1280:33: else:test_expect_test:1280
      │   └─"test/test_expect_test.ml":1274:40: loop_exceeded
      │     ├─<earlier entries truncated>
      │     ├─"test/test_expect_test.ml":1278:9: fun:test_expect_test:1278
      │     │ ├─<earlier entries truncated>
      ...
      │     │     │     │ ├─"test/test_expect_test.ml":1279:15: z
      │     │     │     │ │ └─z = 29
      │     │     │     │ └─"test/test_expect_test.ml":1280:26: then:test_expect_test:1280
      │     │     │     └─loop_exceeded = 435
      │     │     └─loop_exceeded = 6630
      │     └─loop_exceeded = 66345
...
let%expect_test "%debug_this_show function with abstract type" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      "test/test_expect_test.ml":1332:26: foo
      ├─c = 1
      └─foo = 2
      2
    |}]
...
let%expect_test "%debug_this_show PrintBox values_first_mode to stdout with exception" =
  ...
  BEGIN DEBUG SESSION
  loop_truncated
  ├─"test/test_expect_test.ml":1358:41
  ├─x = 7
  ├─z = 3
  │ └─"test/test_expect_test.ml":1359:8
  └─loop_truncated
    ├─"test/test_expect_test.ml":1358:41
    ├─x = 6
    ├─z = 2
...
let%expect_test "%debug_this_show PrintBox values_first_mode to stdout num children \
  ...
  [%expect
    ...
    BEGIN DEBUG SESSION
    _bar
    ├─"test/test_expect_test.ml":1417:26
    ├─_baz = 0
    │ └─"test/test_expect_test.ml":1421:16
    ├─_baz = 2
    │ └─"test/test_expect_test.ml":1421:16
    ├─_baz = 4
    │ └─"test/test_expect_test.ml":1421:16
...
let%expect_test "%track_this_show PrintBox values_first_mode to stdout track for-loop" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      _bar = ()
      ├─"test/test_expect_test.ml":1462:26
      └─for:test_expect_test:1465
        ├─"test/test_expect_test.ml":1465:10
        ├─i = 0
        ├─<for i>
        │ ├─"test/test_expect_test.ml":1465:14
        │ └─_baz = 0
        │   └─"test/test_expect_test.ml":1466:16
        ├─i = 1
        ├─<for i>
        │ ├─"test/test_expect_test.ml":1465:14
        │ └─_baz = 2
...
let%expect_test "%debug_show PrintBox values_first_mode to stdout num children exceeded \
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      loop_exceeded
      ├─"test/test_expect_test.ml":1519:40
      ├─x = 3
      ├─z = 1
      │ └─"test/test_expect_test.ml":1526:17
      └─loop_exceeded
        ├─"test/test_expect_test.ml":1519:40
        ├─x = 2
        ├─z = 0
...
let%expect_test "%debug_this_show elapsed times PrintBox values_first_mode to stdout \
  ...
  [%expect
    {|
      ...
      ├─"test/test_expect_test.ml":1583:40
      ├─<earlier entries truncated>
      ├─z = 4 <N.NNμs>
      │ └─"test/test_expect_test.ml":1588:15
...
let%expect_test "%debug_this_show PrintBox values_first_mode to stdout highlight" =
  ...
  [%expect
    {|
      ...
      │loop_highlight = 9│
      ├──────────────────┘
      ├─"test/test_expect_test.ml":1746:41
      ├─x = 7
      ├─┬─────┐
      │ │z = 3│
      │ ├─────┘
      │ └─"test/test_expect_test.ml":1747:8
      └─┬──────────────────┐
        │loop_highlight = 6│
        ├──────────────────┘
        ├─"test/test_expect_test.ml":1746:41
...
let%expect_test "%track_this_show PrintBox values_first_mode tracking" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      track_branches = 4
      ├─"test/test_expect_test.ml":1812:37
      ├─x = 7
      └─else:test_expect_test:1814
        ├─"test/test_expect_test.ml":1814:9
        └─<match -- branch 1>
          └─"test/test_expect_test.ml":1814:36
      4
      track_branches = -3
      ├─"test/test_expect_test.ml":1812:37
      ├─x = 3
      └─then:test_expect_test:1813
        ├─"test/test_expect_test.ml":1813:18
        └─<match -- branch 2>
          └─"test/test_expect_test.ml":1813:54
      -3
    |}]
...
let%expect_test "%track_show PrintBox values_first_mode to stdout no return type \
  ...
  [%expect
    {|
      ...
      ├─x = 3
      ├─fun:test_expect_test:1847
      │ ├─"test/test_expect_test.ml":1847:50
      │ └─i = 0
      ├─fun:test_expect_test:1847
      │ ├─"test/test_expect_test.ml":1847:50
      │ └─i = 1
...
let%expect_test "%debug_show records" =
  ...
  [%expect
    {|
    BEGIN DEBUG SESSION
    "test/test_expect_test.ml":1876:21: bar
    ├─first = 7
    ├─second = 42
    ├─"test/test_expect_test.ml":1877:8: {first=a; second=b}
    │ ├─a = 7
    │ └─b = 45
    ├─"test/test_expect_test.ml":1878:8: y
    │ └─y = 8
    └─bar = 336
    336
    "test/test_expect_test.ml":1882:10: baz
    ├─first = 7
    ├─second = 42
    ├─"test/test_expect_test.ml":1883:8: {first; second}
    │ ├─first = 8
    │ └─second = 45
    └─baz = 109
    109 |}]
...
let%expect_test "%debug_show tuples" =
  ...
  [%expect
    {|
    BEGIN DEBUG SESSION
    "test/test_expect_test.ml":1911:21: bar
    ├─first = 7
    ├─second = 42
    ...
    └─bar = 336
    336
    "test/test_expect_test.ml":1921:6: (r1, r2)
    ├─"test/test_expect_test.ml":1916:10: baz
    │ ├─first = 7
    │ ├─second = 42
    │ ├─"test/test_expect_test.ml":1917:8: (y, z)
    │ │ ├─y = 8
    │ │ └─z = 3
    │ ├─"test/test_expect_test.ml":1918:8: (a, b)
    │ │ ├─a = 8
    │ │ └─b = 45
    │ └─baz = (339, 109)
    ├─r1 = 339
...
let%expect_test "%debug_show records values_first_mode" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      bar = 336
      ├─"test/test_expect_test.ml":1952:21
      ├─first = 7
      ├─second = 42
      ├─{first=a; second=b}
      │ ├─"test/test_expect_test.ml":1953:8
      │ └─<values>
      │   ├─a = 7
      │   └─b = 45
      └─y = 8
        └─"test/test_expect_test.ml":1954:8
      336
      baz = 109
      ├─"test/test_expect_test.ml":1958:10
      ├─first = 7
      ├─second = 42
      └─{first; second}
        ├─"test/test_expect_test.ml":1959:8
        └─<values>
          ├─first = 8
          └─second = 45
      109 |}]
...
let%expect_test "%debug_show tuples values_first_mode" =
  ...
  [%expect
    ...
    BEGIN DEBUG SESSION
    bar = 336
    ├─"test/test_expect_test.ml":1991:21
    ├─first = 7
    ├─second = 42
    └─y = 8
      └─"test/test_expect_test.ml":1992:8
    336
    (r1, r2)
    ├─"test/test_expect_test.ml":2001:6
    ├─<returns>
    │ ├─r1 = 339
    │ └─r2 = 109
    └─baz = (339, 109)
      ├─"test/test_expect_test.ml":1996:10
      ├─first = 7
      ├─second = 42
      ├─(y, z)
      │ ├─"test/test_expect_test.ml":1997:8
      │ └─<values>
      │   ├─y = 8
      │   └─z = 3
      └─(a, b)
        ├─"test/test_expect_test.ml":1998:8
        └─<values>
          ├─a = 8
          └─b = 45
    339
...
let%expect_test "%track_show variants values_first_mode" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      bar = 16
      ├─"test/test_expect_test.ml":2042:21
      ├─x = 7
      └─y = 8
        └─"test/test_expect_test.ml":2043:8
      16
      baz = 5
      ├─"test/test_expect_test.ml":2048:24
      ├─<function -- branch 0> Left x
      └─x = 4
      5
      baz = 6
      ├─"test/test_expect_test.ml":2049:31
      ├─<function -- branch 1> Right Two y
      └─y = 3
      6
      foo = 3
      ├─"test/test_expect_test.ml":2052:10
      └─<match -- branch 2>
        └─"test/test_expect_test.ml":2053:81
      3 |}]
...
let%expect_test "%debug_show tuples merge type info" =
  ...
  [%expect
    ...
    BEGIN DEBUG SESSION
    (r1, r2)
    ├─"test/test_expect_test.ml":2090:6
    ├─<returns>
    │ ├─r1 = 339
    │ └─r2 = 109
    └─baz = (339, 109)
      ├─"test/test_expect_test.ml":2085:21
      ├─first = 7
      ├─second = 42
      ├─(y, z)
      │ ├─"test/test_expect_test.ml":2086:8
      │ └─<values>
      │   ├─y = 8
      │   └─z = 3
      └─a = 8
        └─"test/test_expect_test.ml":2087:8
    339
    109 |}]
...
let%expect_test "%debug_show decompose multi-argument function type" =
  ...
  [%expect
    ...
    BEGIN DEBUG SESSION
    f = 7
    ├─"test/test_expect_test.ml":2118:44
    └─b = 6
    7
    g = 12
    ├─"test/test_expect_test.ml":2119:56
    └─b = 6
    12 |}]
...
let%expect_test "%debug_show debug type info" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      f : int = 7
      ├─"test/test_expect_test.ml":2138:37
      ├─f : int
      └─b : int = 6
      7
      g : int = 12
      ├─"test/test_expect_test.ml":2139:49
      ├─g : int
      └─b : int = 6
      12 |}]
...
let%expect_test "%track_show options values_first_mode" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      foo = 14
      ├─"test/test_expect_test.ml":2158:21
      └─<match -- branch 1> Some y
        ├─"test/test_expect_test.ml":2159:54
        └─y = 7
      14
      bar = 14
      ├─"test/test_expect_test.ml":2162:10
      ├─l = (Some 7)
      └─<match -- branch 1> Some y
        └─"test/test_expect_test.ml":2162:70
      14
      baz = 8
      ├─"test/test_expect_test.ml":2164:63
      ├─<function -- branch 1> Some y
      └─y = 4
      8
      zoo = 9
      ├─"test/test_expect_test.ml":2166:76
...
let%expect_test "%track_show list values_first_mode" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      foo = 14
      ├─"test/test_expect_test.ml":2197:21
      └─<match -- branch 1> :: (y, _)
        ├─"test/test_expect_test.ml":2197:77
        └─y = 7
      14
      bar = 14
      ├─"test/test_expect_test.ml":2199:10
      ├─l = [7]
      └─<match -- branch 1> :: (y, _)
        └─"test/test_expect_test.ml":2199:66
      14
      baz = 8
      ├─"test/test_expect_test.ml":2203:15
      ├─<function -- branch 1> :: (y, [])
      └─y = 4
      8
      baz = 9
      ├─"test/test_expect_test.ml":2204:18
      ├─<function -- branch 2> :: (y, :: (z, []))
      ├─y = 4
      └─z = 5
      9
      baz = 10
      ├─"test/test_expect_test.ml":2205:21
...
let%expect_test "%track_rtb_show list runtime passing" =
  ...
  [%expect
    {|
      ...
      baz = 8
      ├─"test/test_expect_test.ml":2255:15
      ...
      baz = 10
      ├─"test/test_expect_test.ml":2257:21
...
let%expect_test "%track_rt_show nested procedure runtime passing" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      rt_test
      └─"test/test_expect_test.ml":2330:25

      BEGIN DEBUG SESSION foo-1
      foo-1 foo begin "test/test_expect_test.ml":2332:26:
      foo-1 foo end

      BEGIN DEBUG SESSION foo-2
      foo-2 foo begin "test/test_expect_test.ml":2332:26:
      foo-2 foo end

      BEGIN DEBUG SESSION bar-1
      bar-1 bar begin "test/test_expect_test.ml":2331:26:
       bar-1 fun:test_expect_test:2331 begin "test/test_expect_test.ml":2331:31:
       bar-1 fun:test_expect_test:2331 end
      bar-1 bar end

      BEGIN DEBUG SESSION bar-2
      bar-2 bar begin "test/test_expect_test.ml":2331:26:
       bar-2 fun:test_expect_test:2331 begin "test/test_expect_test.ml":2331:31:
       bar-2 fun:test_expect_test:2331 end
      bar-2 bar end |}]
...
let%expect_test "%log constant entries" =
  ...
  [%expect
    {|
      ...
      bar
      ├─"test/test_expect_test.ml":2378:21
      ├─This is the first log line
      ├─This is the
      │ ├─2
      │ └─log line
...
let%expect_test "%log with type annotations" =
  ...
  [%expect
    {|
          BEGIN DEBUG SESSION
          foo = ()
          ├─"test/test_expect_test.ml":2409:21
...
let%expect_test "%log with default type assumption" =
  ...
  [%expect
    {|
          BEGIN DEBUG SESSION
          foo = ()
          ├─"test/test_expect_test.ml":2434:21
          ├─"2*3"
          ├─("This is like", "3", "or", "3.14", "above")
          ├─("tau =", "2*3.14")
          └─[("2*3", 0); ("1", 1); ("2", 2); ("3", 3)] |}]
...
let%expect_test "%log track while-loop" =
  ...
  [%expect
    {|
    BEGIN DEBUG SESSION
    "test/test_expect_test.ml":2456:17: result
    └─"test/test_expect_test.ml":2459:4: while:test_expect_test:2459
      ├─"test/test_expect_test.ml":2460:6: <while loop>
      │ ├─(1 i= 0)
      │ ├─(2 i= 1)
      │ └─(3 j= 1)
      ├─"test/test_expect_test.ml":2460:6: <while loop>
...
let%expect_test "%log runtime log levels while-loop" =
  ...
  "test/test_expect_test.ml":2502:28: Everything result
  ├─"test/test_expect_test.ml":2505:4: Everything while:test_expect_test:2505
  │ ├─"test/test_expect_test.ml":2507:6: Everything <while loop>
  │ │ ├─"test/test_expect_test.ml":2507:21: Everything then:test_expect_test:2507
  │ │ │ └─(ERROR: 1 i= 0)
  │ │ ├─(WARNING: 2 i= 1)
  │ │ ├─"test/test_expect_test.ml":2510:11: Everything fun:test_expect_test:2510
  │ │ └─(INFO: 3 j= 1)
  │ ├─"test/test_expect_test.ml":2507:6: Everything <while loop>
  │ │ ├─"test/test_expect_test.ml":2507:21: Everything then:test_expect_test:2507
  │ │ │ └─(ERROR: 1 i= 1)
  ...
  │ │ └─(INFO: 3 j= 3)
  │ ├─"test/test_expect_test.ml":2507:6: Everything <while loop>
  │ │ ├─"test/test_expect_test.ml":2507:63: Everything else:test_expect_test:2507
  │ │ ├─(WARNING: 2 i= 3)
  │ │ ├─"test/test_expect_test.ml":2510:11: Everything fun:test_expect_test:2510
  │ │ └─(INFO: 3 j= 6)
  │ ├─"test/test_expect_test.ml":2507:6: Everything <while loop>
  ...
  result = 21
  ├─"test/test_expect_test.ml":2502:28
  └─Nonempty while:test_expect_test:2505
    ├─"test/test_expect_test.ml":2505:4
    ├─Nonempty <while loop>
    │ ├─"test/test_expect_test.ml":2507:6
    │ ├─Nonempty then:test_expect_test:2507
    │ │ ├─"test/test_expect_test.ml":2507:21
    │ │ └─(ERROR: 1 i= 0)
    │ ├─(WARNING: 2 i= 1)
    │ └─(INFO: 3 j= 1)
    ├─Nonempty <while loop>
  ...
  Prefixed result
  ├─"test/test_expect_test.ml":2502:28
  └─Prefixed while:test_expect_test:2505
    ├─"test/test_expect_test.ml":2505:4
    ├─Prefixed <while loop>
    │ ├─"test/test_expect_test.ml":2507:6
    │ ├─Prefixed then:test_expect_test:2507
    │ │ ├─"test/test_expect_test.ml":2507:21
    │ │ └─(ERROR: 1 i= 0)
    │ └─(WARNING: 2 i= 1)
    ├─Prefixed <while loop>
  ...
  result = 21
  ├─"test/test_expect_test.ml":2502:28
  └─Prefixed_or_result while:test_expect_test:2505
    ├─"test/test_expect_test.ml":2505:4
    ├─Prefixed_or_result <while loop>
    │ ├─"test/test_expect_test.ml":2507:6
    │ ├─Prefixed_or_result then:test_expect_test:2507
    │ │ ├─"test/test_expect_test.ml":2507:21
    │ │ └─(ERROR: 1 i= 0)
    │ └─(WARNING: 2 i= 1)
    ├─Prefixed_or_result <while loop>
...
let%expect_test "%log compile time log levels while-loop" =
  ...
  BEGIN DEBUG SESSION
  everything = 21
  ├─"test/test_expect_test.ml":2688:28
  └─while:test_expect_test:2693
    ├─"test/test_expect_test.ml":2693:6
    ├─<while loop>
    │ ├─"test/test_expect_test.ml":2695:8
    │ ├─then:test_expect_test:2695
    │ │ ├─"test/test_expect_test.ml":2695:23
    │ │ └─(ERROR: 1 i= 0)
    │ ├─(WARNING: 2 i= 1)
    │ ├─fun:test_expect_test:2698
    │ │ └─"test/test_expect_test.ml":2698:13
    │ └─(INFO: 3 j= 1)
    ├─<while loop>
    │ ├─"test/test_expect_test.ml":2695:8
    │ ├─then:test_expect_test:2695
    ...
    ├─<while loop>
    │ ├─"test/test_expect_test.ml":2695:8
    │ ├─else:test_expect_test:2695
    │ │ └─"test/test_expect_test.ml":2695:65
    │ ├─(WARNING: 2 i= 3)
    │ ├─fun:test_expect_test:2698
    │ │ └─"test/test_expect_test.ml":2698:13
    │ └─(INFO: 3 j= 6)
  ...
  21
  nothing = 21
  └─"test/test_expect_test.ml":2703:25
  21
  prefixed = 21
  ├─"test/test_expect_test.ml":2719:26
  └─while:test_expect_test:2724
    ├─"test/test_expect_test.ml":2724:6
    ├─<while loop>
    │ ├─"test/test_expect_test.ml":2726:8
    │ ├─then:test_expect_test:2726
    │ │ ├─"test/test_expect_test.ml":2726:23
    │ │ └─(ERROR: 1 i= 0)
    │ └─(WARNING: 2 i= 1)
    ├─<while loop>
    │ ├─"test/test_expect_test.ml":2726:8
...
let%expect_test "%log compile time log levels runtime-passing while-loop" =
  ...
  BEGIN DEBUG SESSION prefixed
  prefixed = 21
  ├─"test/test_expect_test.ml":2855:34
  └─prefixed while:test_expect_test:2858
    ├─"test/test_expect_test.ml":2858:8
    ├─prefixed <while loop>
    │ ├─"test/test_expect_test.ml":2860:10
    │ ├─prefixed then:test_expect_test:2860
    │ │ ├─"test/test_expect_test.ml":2860:25
    │ │ └─(ERROR: 1 i= 0)
    │ └─(WARNING: 2 i= 1)
    ├─prefixed <while loop>
    │ ├─"test/test_expect_test.ml":2860:10
  ...
  21
  TOPLEVEL ()
  └─"test/test_expect_test.ml":2833:17
      |}]
...
let%expect_test "%log track while-loop result" =
  ...
  [%expect
    ...
    BEGIN DEBUG SESSION
    21
    ├─"test/test_expect_test.ml":2916:17
    └─while:test_expect_test:2919
      ├─"test/test_expect_test.ml":2919:4
      ├─(3 j= 1)
      │ ├─"test/test_expect_test.ml":2920:6
      │ ├─<while loop>
      │ ├─(1 i= 0)
      │ └─(2 i= 1)
      ├─(3 j= 3)
...
let%expect_test "%diagn_show ignores type annots" =
  ...
  [%expect
    {|
      ...
      109
      toplevel
      ├─"test/test_expect_test.ml":3097:17
      ├─("for bar, b-3", 42)
...
let%expect_test "%diagn_show ignores non-empty bindings" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      bar
      ├─"test/test_expect_test.ml":3125:21
      └─("for bar, b-3", 42)
      336
      baz
      ├─"test/test_expect_test.ml":3132:21
...
let%expect_test "%debug_show log level Prefixed_or_result [||]" =
  ...
  [%expect
    {|
      ...
      109
      ()
      ├─"test/test_expect_test.ml":3172:17
      ├─bar = 336
      │ ├─"test/test_expect_test.ml":3175:14
      │ ├─{first=a; second=b}
      │ │ ├─"test/test_expect_test.ml":3176:12
      │ │ └─<values>
      │ │   ├─a = 7
      │ │   └─b = 45
      │ ├─y = 8
      │ │ └─"test/test_expect_test.ml":3177:12
      │ └─("for bar, b-3", 42)
      └─baz = 109
        ├─"test/test_expect_test.ml":3181:14
        ├─{first; second}
        │ ├─"test/test_expect_test.ml":3182:12
        │ └─<values>
        │   ├─first = 8
        │   └─second = 45
        └─("for baz, f squared", 64) |}]
...
let%expect_test "%debug_show log level Prefixed_or_result [||] compile+runtime" =
  ...
  [%expect
    {|
        ...
        109
        ()
        ├─"test/test_expect_test.ml":3245:17
        ├─bar = 336
        │ ├─"test/test_expect_test.ml":3248:14
        │ └─("for bar, b-3", 42)
        └─baz = 109
          ├─"test/test_expect_test.ml":3254:14
          └─("for baz, f squared", 64) |}]
...
let%expect_test "%debug_this_show PrintBox snapshot" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      loop_highlight
      ├─"test/test_expect_test.ml":3278:41
      ├─x = 7
      └─z = 3
        └─"test/test_expect_test.ml":3279:8
...
let%expect_test "%log_printbox" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      foo = ()
      ├─"test/test_expect_test.ml":3378:21
      ├─0/0│0/1│0/2│0/3│0/4
      │ ───┼───┼───┼───┼───
      │ 1/0│1/1│1/2│1/3│1/4
      │ ───┼───┼───┼───┼───
...
let%expect_test "%log_printbox flushing" =
  ...
  [%expect
    {|
      BEGIN DEBUG SESSION
      foo begin "test/test_expect_test.ml":3439:21:
       0/0│0/1│0/2│0/3│0/4
       ───┼───┼───┼───┼───
       1/0│1/1│1/2│1/3│1/4
       ───┼───┼───┼───┼───
       ...
       "No bars but pad:"
        ...
        4/0  4/1  4/2  4/3  4/4
       bar begin "test/test_expect_test.ml":3448:12:
        "Now with a frame:"
        ┌───┬───┬───┬───┬───┐
        │0/0│0/1│0/2│0/3│0/4│
        ├───┼───┼───┼───┼───┤
...
let%expect_test "flame graph" =
  ...
  [%expect
    {|
                        <div style="position: relative; height: 0px;"><div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #a3b8d2;"><div><div><a href="./test_expect_test_flame_graph.html#1"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #a7a1eb;"><div><div><a href="./test_expect_test_flame_graph.html#2"><div>&quot;test/test_expect_test.ml&quot;:3569:10: y</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #b88f91;"><div><div><a href="./test_expect_test_flame_graph.html#3"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #bfadb3;"><div><div><a href="./test_expect_test_flame_graph.html#4"><div>&quot;test/test_expect_test.ml&quot;:3569:10: y</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #c5c7ed;"><div><div><a href="./test_expect_test_flame_graph.html#5"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #ebdf9d;"><div><div><a href="./test_expect_test_flame_graph.html#6"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #bfbbe7;"><div><div><a href="./test_expect_test_flame_graph.html#7"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0px; left: 0px; width: 100%; background: #ebebd3;"><div><div><a href="./test_expect_test_flame_graph.html#8"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div></div>
           </div></div>
           </div></div>
           </div></div>
           ...
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #9994b2;"><div><div><a href="./test_expect_test_flame_graph.html#9"><div>&quot;test/test_expect_test.ml&quot;:3570:10: z</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #c4efdd;"><div><div><a href="./test_expect_test_flame_graph.html#10"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #d8eeca;"><div><div><a href="./test_expect_test_flame_graph.html#11"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #bea2e0;"><div><div><a href="./test_expect_test_flame_graph.html#12"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0px; left: 0px; width: 100%; background: #9192c4;"><div><div><a href="./test_expect_test_flame_graph.html#13"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div></div>
           </div></div>
           </div></div>
           </div></div>
           ...
           <div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #bb8f91;"><div><div><a href="./test_expect_test_flame_graph.html#14"><div>&quot;test/test_expect_test.ml&quot;:3570:10: z</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #bd8fef;"><div><div><a href="./test_expect_test_flame_graph.html#15"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #d7decc;"><div><div><a href="./test_expect_test_flame_graph.html#16"><div>&quot;test/test_expect_test.ml&quot;:3569:10: y</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #9fbbbd;"><div><div><a href="./test_expect_test_flame_graph.html#17"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #e2e7d3;"><div><div><a href="./test_expect_test_flame_graph.html#18"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #a0b0f0;"><div><div><a href="./test_expect_test_flame_graph.html#19"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0px; left: 0px; width: 100%; background: #a39abc;"><div><div><a href="./test_expect_test_flame_graph.html#20"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div></div>
           </div></div>
           </div></div>
           </div></div>
           ...
           <div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #b1a1b5;"><div><div><a href="./test_expect_test_flame_graph.html#21"><div>&quot;test/test_expect_test.ml&quot;:3570:10: z</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #d7efa5;"><div><div><a href="./test_expect_test_flame_graph.html#22"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #f1e7a3;"><div><div><a href="./test_expect_test_flame_graph.html#23"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #9295dd;"><div><div><a href="./test_expect_test_flame_graph.html#24"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0px; left: 0px; width: 100%; background: #d6dcaa;"><div><div><a href="./test_expect_test_flame_graph.html#25"><div>&quot;test/test_expect_test.ml&quot;:3565:26: loop</div></a></div></div>
    </div></div>
           </div></div>
           </div></div>
           </div></div>
...
let%expect_test "flame graph reduced ToC" =
  ...
  [%expect
    {|
                        <div style="position: relative; height: 0px;"><div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #d7efa5;"><div><div><a href="./test_expect_test_flame_graph.html#1"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #9994b2;"><div><div><a href="./test_expect_test_flame_graph.html#2"><div>&quot;test/test_expect_test.ml&quot;:3672:10: y</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #c4efdd;"><div><div><a href="./test_expect_test_flame_graph.html#3"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #c5c7ed;"><div><div><a href="./test_expect_test_flame_graph.html#4"><div>&quot;test/test_expect_test.ml&quot;:3672:10: y</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #ebdf9d;"><div><div><a href="./test_expect_test_flame_graph.html#5"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #bfbbe7;"><div><div><a href="./test_expect_test_flame_graph.html#6"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0px; left: 0px; width: 100%; background: #ebebd3;"><div><div><a href="./test_expect_test_flame_graph.html#7"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div></div>
           </div></div>
           </div></div>
           </div></div>
           <div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #d8eeca;"><div><div><a href="./test_expect_test_flame_graph.html#9"><div>&quot;test/test_expect_test.ml&quot;:3673:10: z</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #bea2e0;"><div><div><a href="./test_expect_test_flame_graph.html#10"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #9192c4;"><div><div><a href="./test_expect_test_flame_graph.html#11"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0px; left: 0px; width: 100%; background: #bfadb3;"><div><div><a href="./test_expect_test_flame_graph.html#12"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div></div>
           </div></div>
           </div></div>
           </div></div>
           ...
           <div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #f1e7a3;"><div><div><a href="./test_expect_test_flame_graph.html#14"><div>&quot;test/test_expect_test.ml&quot;:3673:10: z</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #9295dd;"><div><div><a href="./test_expect_test_flame_graph.html#15"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #a0b0f0;"><div><div><a href="./test_expect_test_flame_graph.html#16"><div>&quot;test/test_expect_test.ml&quot;:3672:10: y</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #a39abc;"><div><div><a href="./test_expect_test_flame_graph.html#17"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #a7a1eb;"><div><div><a href="./test_expect_test_flame_graph.html#18"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0px; left: 0px; width: 100%; background: #b88f91;"><div><div><a href="./test_expect_test_flame_graph.html#19"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div></div>
           </div></div>
           </div></div>
           </div></div>
           <div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #d6dcaa;"><div><div><a href="./test_expect_test_flame_graph.html#21"><div>&quot;test/test_expect_test.ml&quot;:3673:10: z</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #d7decc;"><div><div><a href="./test_expect_test_flame_graph.html#22"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0%; width: 100%; height: 100%;"><div style="position: relative; top: 0px; left: 0px; width: 100%; background: #9fbbbd;"><div><div><a href="./test_expect_test_flame_graph.html#23"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div><div style="position: relative; top:10%; height: 90%; left:N.NNNN%; width:N.NNNN%;">
           <div style="position: relative; top: 0px; left: 0px; width: 100%; background: #e2e7d3;"><div><div><a href="./test_expect_test_flame_graph.html#24"><div>&quot;test/test_expect_test.ml&quot;:3668:26: loop</div></a></div></div>
    </div></div>
           </div></div>
           </div></div>
           </div></div>
