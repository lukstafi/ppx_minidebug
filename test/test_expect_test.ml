...
let%expect_test "%debug_show PrintBox to stdout track for-loop num children exceeded" =
  ...
  [%expect
    ...
    └─"test/test_expect_test.ml":265:8: <for loop>
      ├─i = 0
      ├─"test/test_expect_test.ml":265:12: i
...
let%expect_test "%debug_show PrintBox to stdout track for-loop" =
  ...
  [%expect
    {|
      ...
      │ ├─i = 0
      │ ├─"test/test_expect_test.ml":307:12: i
...
let%expect_test "%debug_show PrintBox to stdout num children exceeded nested" =
  ...
  [%expect
    {|
      ...
      ├─x = 3
      ├─"test/test_expect_test.ml":396:15: z
      │ └─z = 1
      └─"test/test_expect_test.ml":391:40-397:69: loop_exceeded
        ├─x = 2
        ├─"test/test_expect_test.ml":396:15: z
...
let%expect_test "%debug_show PrintBox to stdout highlight" =
  ...
  [%expect
    {|
      ...
      ├─x = 7
      ├─┬───────────────────────────────────┐
      │ │"test/test_expect_test.ml":448:8: z│
      │ ├───────────────────────────────────┘
      │ └─┬─────┐
      │   │z = 3│
      │   └─────┘
...
let%expect_test "%debug_show PrintBox tracking with debug_notrace" =
  ...
  [%expect
    {|
      ...
      │ └─"test/test_expect_test.ml":575:14: result
      │   └─result = 3
      └─track_branches = 3
      3
    |}]
...
let%expect_test "nested extension points are no-ops" =
  ...
  [%expect
    {|
      ...
      │   └─"test/test_expect_test.ml":627:23: result
      ...
      │ └─"test/test_expect_test.ml":620:25: result
      │   └─result = 3
      └─track_branches = 3
      3
    |}]
  ...
  [%expect
    {|
      ...
      └─"test/test_expect_test.ml":698:9-700:69: __fun
        ├─i = 0
        ├─"test/test_expect_test.ml":699:15: z
        │ └─z = 1
