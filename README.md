...
```ocaml
  ...
  [%expect
    {|
    Raised exception.
    [debug] loop_exceeded @ test/test_expect_test.ml:266:35-270:60
      x = 7
      [debug] z @ test/test_expect_test.ml:269:10-269:11
        z => 3
      [debug] loop_exceeded @ test/test_expect_test.ml:266:35-270:60
        x = 6
        [debug] z @ test/test_expect_test.ml:269:10-269:11
...
```ocaml
  ...
  [%expect
    ...
    [debug] _bar @ test/test_expect_test.ml:317:21-317:25
      [debug] _baz @ test/test_expect_test.ml:321:16-321:20
        _baz => 0
      [debug] _baz @ test/test_expect_test.ml:321:16-321:20
        _baz => 2
      [debug] _baz @ test/test_expect_test.ml:321:16-321:20
...
```ocaml
  ...
  [%expect
    ...
    8
    3
    [track] track_branches @ test/test_expect_test.ml:734:32-748:16
      x = 8
      [track] else:test_expect_test:743 @ test/test_expect_test.ml:743:6-748:16
        [track] <match -- branch 2> @ test/test_expect_test.ml:747:10-748:16
          [track] result @ test/test_expect_test.ml:747:14-747:20
            then:test_expect_test:747 =
            result => 8
      track_branches => 8
    [track] track_branches @ test/test_expect_test.ml:734:32-748:16
      x = 3
      [track] then:test_expect_test:736 @ test/test_expect_test.ml:736:6-741:16
        [debug] result @ test/test_expect_test.ml:740:14-740:20
          result => 3
      track_branches => 3
    |}]
```
...
```ocaml
  ...
  [%expect
    {|
    6
    [track] anonymous @ test/test_expect_test.ml:950:27-951:70
      x = 3
      [track] fun:test_expect_test:951 @ test/test_expect_test.ml:951:50-951:70
        i = 0
      [track] fun:test_expect_test:951 @ test/test_expect_test.ml:951:50-951:70
        i = 1
      [track] fun:test_expect_test:951 @ test/test_expect_test.ml:951:50-951:70
...
```ocaml
  ...
  [%expect
    {|
    9
    [debug] loop_changes @ test/test_expect_test.ml:168:34-174:7
      x = 7
      [debug] z @ test/test_expect_test.ml:169:8-169:9
        z => 3
      [debug] loop_changes @ test/test_expect_test.ml:168:34-174:7
        x = 6
        [debug] z @ test/test_expect_test.ml:169:8-169:9
...
```ocaml
  ...
  [%expect
    ...
    7
    12
    [debug] f : int => 7 @ test/test_expect_test.ml:1640:37-1640:54
      b : int = 6
    [debug] g : int => 12 @ test/test_expect_test.ml:1641:49-1641:72
      b : int = 6
    |}]
```
